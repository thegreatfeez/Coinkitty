...
export default function Home(){
    ...
    return (
        <div className="bg-slate-900 text-white min-h-screen p-6">
            <h1 className="text-2xl font-bold mb-8 text-white">Top Cryptocurrencies</h1>
                ...
                <div className="bg-slate-800 rounded-lg overflow-hidden">
                    ...
                    {prices.map((coin, index) => (
                        ...
                        >
                            ...
                            <div className={`font-semibold ${coin.price_change_percentage_24h >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                                {coin.price_change_percentage_24h >= 0 ? '+' : ''}{coin.price_change_percentage_24h?.toFixed(2)}%
                            </div>
                            
                            <div className="text-white">
                                ${coin.market_cap ? (coin.market_cap / 1e9).toFixed(0) + 'B' : 'N/A'}
                            </div>
