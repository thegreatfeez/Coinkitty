  ...
  return (
    <div className="max-w-lg mx-auto mt-10 bg-gray-900 border border-gray-800 rounded-xl p-6 shadow-lg text-white">
      ...
      <p className="mt-4 text-gray-300 leading-relaxed">
        ...
        <br />
        <strong className="text-indigo-300">Insight</strong> scans profitable
        wallets, copies pro-level strategies, analyzes tokens instantly, and
        provides professional trading tools — all while keeping your wallet
        safe.
      </p>
      ...
      <div className="mt-6 bg-gray-800/60 rounded-lg p-4 text-center border border-gray-700">
        <p className="text-sm text-gray-400">
          💡 Coming soon: Get the edge to spot the{" "}
          <span className="text-indigo-300 font-medium">next x10 token</span>{" "}
          before the crowd.
        </p>
